...
- [0062-受講者ソースはアーカイブ一括取得を主経路とし3段で縮退する.md](ddr/0062-受講者ソースはアーカイブ一括取得を主経路とし3段で縮退する.md)
- [0063-受講者ソースの縮退はdegradedフラグで表しエージェント定義を機械的に分岐させる.md](ddr/0063-受講者ソースの縮退はdegradedフラグで表しエージェント定義を機械的に分岐させる.md)
- [0064-有効行の判定は共通関数へ寄せold_lineの扱いだけを引数で切り替える.md](ddr/0064-有効行の判定は共通関数へ寄せold_lineの扱いだけを引数で切り替える.md)
- [0065-対応付けと禁止語の材料は受講者ソース全体へ広げる.md](ddr/0065-対応付けと禁止語の材料は受講者ソース全体へ広げる.md)
